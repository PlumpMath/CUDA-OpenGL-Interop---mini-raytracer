#comes from the nvidia sdk samples, edit by me.
...
build: raytraceInterop

raytraceInterop.o: src/raytraceInterop.cu
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

raytraceInterop: raytraceInterop.o
...
run: build
	$(EXEC) ./raytraceInterop

clean:
	$(EXEC) rm -f raytraceInterop.o raytraceInterop.bin raytraceInterop
	$(EXEC) rm -rf ../../bin/$(OS_ARCH)/$(OSLOWER)/$(TARGET)$(if $(abi),/$(abi))/raytraceInterop
